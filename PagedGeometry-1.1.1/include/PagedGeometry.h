...
public:
   ...
   //ADDED BY: JH
	inline void setImposterAlphaRejectValue(float imposterAlphaRejectValue) { this->m_ImposterAlphaRejectValue = imposterAlphaRejectValue; }
	inline float getImposterAlphaRejectValue() { return m_ImposterAlphaRejectValue; }
...
protected:
	...
	float m_ImposterAlphaRejectValue; //ADDED BY: JH
